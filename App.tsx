...
export const App: React.FC = () => {
  ...
  // View State for Pan/Zoom in Single Node
  ...
  const getSimConfig = useCallback((): SimulationConfig => ({
      ...
      arrivalType,
      arrivalK: erlangK,
      serviceType: DistributionType.POISSON, // Force Poisson for now if not exposed fully
  ...
  const resetSimulation = useCallback(() => {
    ...
    setFloorViewState({ x: 0, y: 0, scale: 1 }); // Reset View
